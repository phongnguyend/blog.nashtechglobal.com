...
- [Entity Framework Core Tips: Making Queries Run As Fast As Dapper - NashTech Insights](https://blog.nashtechglobal.com/entity-framework-core-tips-making-queries-run-as-fast-as-dapper/)
